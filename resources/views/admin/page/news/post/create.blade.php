@extends('admin.index')
@section('style')
<link href="/admin/mystyle/bs-multiselect/bootstrap-multiselect.css" rel="stylesheet" type="text/css" />
<style type="text/css">
		        	...
		        	<div class="col-md-12">
		        		<div class="portlet light bordered">
	                        <div class="portlet-body form">
	                            ...
	                            <div class="form-group">
	                                <label>Slug</label>
	                                <input type="text" class="form-control input-slug" placeholder="Slug" name="slug" value="{{old('slug')}}" > 
	                            </div>
	                            <div class="form-group">
	                                <label>Mô tả</label>
	                            ...
	                            <div class="form-group">
									...
									<select id="chkveg" multiple="multiple" name="categories[]">
										{!!$html_option!!}
									</select>
	                            </div>
	                            <div class="form-group">
                                ...
                                <div class="form-group">
	                                <label>Vị trí</label>
	                                <input type="number" min="1" class="form-control" name="order" value="{{$count_news}}" style="width: 100px;">
	                            </div>
	                            <div class="form-group">
...
<script type="text/javascript">
	...
	$("input[type='text'].input-slug").on('keyup', function() {
		$("input[name='slug']").val(to_slug($(this).val()));
	 });
...
<script src="/admin/mystyle/bs-multiselect/bootstrap-multiselect.js"></script>
<script type="text/javascript">
	$(function() {
		$('#chkveg').multiselect({
