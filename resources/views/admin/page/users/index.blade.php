                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="text-center"> 
                            	<button type="button" class="btn btn-primary click-view" title="View" data-link="{{route('admin.users.view',['id'=>$row->id])}}"><i class="fa fa-eye"></i></button>
                            	<a href="{{route('admin.users.edit',['id'=>$row->id])}}"><button type="button" class="btn yellow-crusta" title="Edit"><i class="fa fa-edit"></i></button></a>
                            	<button type="button" class="btn red click-delete" title="Delete" data-link="{{route('admin.users.delete',['id'=>$row->id])}}"><i class="fa fa-trash"></i></button> 
                            </td>
                        </tr>
                        @endforeach
                       @endif
