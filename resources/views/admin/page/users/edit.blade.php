...
@section('content')
	<div class="page-content-wrapper">
	    <div class="page-content">
	        ...
	        <form action="{{route('admin.users.update',['id'=>$row->id])}}" method="post" enctype="multipart/form-data">
		        <div class="row">
		        	<div class="col-md-6">
	                         ...
	                         <div class="portlet-body form">
	                    		<div class="form-group">
	                                ...
	                                <div class="input-group">
	                                    ...
	                                    <input type="text" class="form-control" placeholder="User Login" name="userlogin" value="{{$row->name}}" readonly="readonly"> 
	                                </div>
	                            </div>
	                            <div class="form-group">
	                                ...
	                                <div class="input-group">
	                                    ...
	                                    <input type="text" class="form-control" placeholder="Full name" name="fullname" value="{{$row->fullname}}"> 
	                                </div>
	                            </div>
	                            <div class="form-group">
	                            ...
	                            <div class="form-group">
	                                <label>Phone <span class="require-field">(*)</span></label>
	                                <div class="input-group">
	                                    <span class="input-group-addon">
	                            ...
	                            <div class="form-group">
	                                <label>Address <span class="require-field">(*)</span></label>
	                                <div class="input-group">
	                                    <span class="input-group-addon">
	                            ...
	                            <div class="form-group">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="height: 150px;">
                                            <img src="/uploads/user/{{$row->photo}}" alt="" /> </div>
